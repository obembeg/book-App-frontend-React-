    ...
    <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
              Your premium reading companion. Organize, track, and accomplish
              your reading goals with our clean, modern books dashboard.
            </p>
            <div className="flex gap-4 pt-2">
              ...
              <a
                href="https://github.com/obembeg/book-App-frontend-React-.git"
                target="_blank"
                className="p-2 rounded-lg bg-slate-900/50 hover:bg-slate-900 hover:text-indigo-400 transition duration-200"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <p
                  className="hover:text-white transition duration-200 cursor-help"
              ...
              <li className="text-sky-600">
                {support
                  ? "Contact support team via email: godwinobembe@gmail.com"
                  : ""}
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <button
              ...
              className="mt-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-sm font-semibold transition duration-200 cursor-pointer active:scale-95 whitespace-nowrap shadow-lg shadow-indigo-600/10 w-full"
            >
              {join ? "Coming Soon...🚀" : "Join"}
            </button>
            {/* </form> */}
          </div>
        </div>
        ...
        <div className="border-t border-slate-900 mt-12 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-slate-500 gap-4">
          <p>&copy; {new Date().getFullYear()} OG. All rights reserved.</p>
